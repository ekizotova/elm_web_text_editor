...
var $author$project$Main$GotUpdatedText = function (a) {
	return {$: 'GotUpdatedText', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$receiveUpdatedText = _Platform_incomingPort('receiveUpdatedText', $elm$json$Json$Decode$string);
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$receiveUpdatedText($author$project$Main$GotUpdatedText);
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 'FormatBold':
				return _Utils_Tuple2(
					model,
					$author$project$Main$applyFormat('bold'));
			case 'FormatItalic':
				return _Utils_Tuple2(
					model,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Elm Text Editor')
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$FormatBold)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$FormatItalic)
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Aktuální HTML výstup:')
					])),
				A2(
				$elm$html$Html$pre,
				_List_Nil,
